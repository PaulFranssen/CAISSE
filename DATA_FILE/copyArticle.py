...
class Database:
    ...
    def copier(self):
        ...
        # res = self.curseur.execute("""SELECT code, des, pv FROM article""",(1,)).fetchall()
        ...
        self.curseur2.execute("""CREATE TABLE IF NOT EXISTS articles (
            ...
            # for tup in res:
        self.curseur2.execute("""INSERT INTO articles (code, descript, prix) VALUES(?,?,?)""",("jb", "alcool", 10000))
